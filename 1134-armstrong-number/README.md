<h2><a href="https://leetcode.com/problems/armstrong-number">1134. Armstrong Number</a></h2><h3>Easy</h3><hr><p>Given an integer <code>n</code>, return <code>true</code> <em>if and only if it is an <strong>Armstrong number</strong></em>.</p>
